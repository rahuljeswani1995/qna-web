...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _resolvers_test_data_resolver__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./resolvers/test-data.resolver */
    ...
    var routes = [{
      ...
      resolve: {
        serverData: _resolvers_test_data_resolver__WEBPACK_IMPORTED_MODULE_5__["TestDataResolver"]
      }
    }];
  ...
  function srcAppMainPageMainPageComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_user_profile_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    function MainPageComponent_div_7_tr_15_Template(rf, ctx) {
      if (rf & 1) {
    ...
    /*#__PURE__*/
    function () {
      function MainPageComponent(router, userSvc) {
    ...
    MainPageComponent.ɵfac = function MainPageComponent_Factory(t) {
      return new (t || MainPageComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_user_profile_service__WEBPACK_IMPORTED_MODULE_2__["UserProfileService"]));
    };
    ...
    MainPageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function MainPageComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MainPageComponent_Template_button_click_9_listener($event) {
            return ctx.startNewTest();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MainPageComponent, [{
        ...
        return [{
          ...
          type: _services_user_profile_service__WEBPACK_IMPORTED_MODULE_2__["UserProfileService"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcAppResolversTestDataResolverTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TestDataResolver", function () {
    ...
    var TestDataResolver =
    /*#__PURE__*/
    function () {
      function TestDataResolver(dataService) {
        _classCallCheck(this, TestDataResolver);

        this.dataService = dataService;
      }

      _createClass(TestDataResolver, [{
        key: "resolve",
    ...
    TestDataResolver.ɵfac = function TestDataResolver_Factory(t) {
      return new (t || TestDataResolver)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_services_data_service__WEBPACK_IMPORTED_MODULE_1__["DataService"]));
    };

    TestDataResolver.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: TestDataResolver,
      factory: TestDataResolver.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TestDataResolver, [{
  ...
  function srcAppTestTestComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _models_question_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../../models/question.model */
    "./src/models/question.model.ts");
    /* harmony import */


    var src_models_answer_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/models/answer.model */
    ...
    function TestComponent_option_8_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function TestComponent_div_10_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TestComponent_div_10_Template_div_click_0_listener($event) {
          ...
          return ctx_r5.onQuestionSelect(question_r4.id);
        });
    ...
    function TestComponent_div_15_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function TestComponent_div_15_Template_input_change_2_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r9);

          var ctx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r8.onAnswerSelect($event.target.value);
        });
    ...
    /*#__PURE__*/
    function () {
      function TestComponent(route, router, userSvc) {
      ...
      _createClass(TestComponent, [{
        ...
        key: "transformIntoModel",
        value: function transformIntoModel(rawData) {
          var questions = [];
          rawData.forEach(function (rawQn, idx) {
            var qn = new _models_question_model__WEBPACK_IMPORTED_MODULE_1__["Question"]();
            ...
            var ans_options = [];
            rawQn.answers.forEach(function (rawAns) {
              var answer = new src_models_answer_model__WEBPACK_IMPORTED_MODULE_2__["Answer"]();
              answer.id = rawAns.id;
        ...
        key: "filterOutSections",
        value: function filterOutSections(questions) {
          return new Set(questions.map(function (x) {
            return x.category;
          }));
        }
      }, {
        key: "onSectionFilter",
        value: function onSectionFilter(section) {
          if (section == "all") this.questionsToDisplay = this.questionsModel;else this.questionsToDisplay = this.questionsModel.filter(function (qn) {
            return qn.category == section;
          });
          this.currentQuestion = this.questionsToDisplay[0];
        }
      }, {
        key: "onQuestionSelect",
        value: function onQuestionSelect(questionId) {
          this.currentQuestion = this.questionsToDisplay.find(function (q) {
            return q.id === questionId;
          });
        }
      }, {
        key: "onAnswerSelect",
        value: function onAnswerSelect(ansId) {
          this.currentQuestion.userSelection = ansId;
        }
      }, {
        key: "onSubmit",
        value: function onSubmit() {
          var numAttempted = this.questionsModel.filter(function (el) {
            return el.userSelection != null && el.userSelection != undefined;
          }).length;

          if (window.confirm("You have attempted ".concat(numAttempted, " out of ").concat(this.questionsModel.length, " questions. Are you sure you want to submit?"))) {
            // submit
            // save score
            this.saveTestScore();
            this.router.navigateByUrl("/main"); // route to home page
          }
        }
      }, {
        key: "saveTestScore",
        value: function saveTestScore() {
          var totalQuestions = this.questionsModel.length;
          var numCorrect = this.questionsModel.filter(function (el) {
            return el.userSelection !== null && el.userSelection === el.answer_id;
          }).length;
          var percentScore = numCorrect / totalQuestions * 100;
          var email = this.userSvc.getUserEmail();
          var tests = JSON.parse(localStorage.getItem(email));
          var date = new Date();
          tests.push({
            "date": "".concat(date.toLocaleDateString(), " ").concat(date.toLocaleTimeString()),
    ...
    TestComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function TestComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function TestComponent_Template_select_change_5_listener($event) {
            return ctx.onSectionFilter($event.target.value);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TestComponent_Template_button_click_18_listener($event) {
            return ctx.onSubmit();
          });
  ...
  function srcAppWelcomeWelcomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_user_profile_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../services/user-profile.service */
    "./src/app/services/user-profile.service.ts");
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function WelcomeComponent(userSvc, router) {
      ...
      _createClass(WelcomeComponent, [{
        ...
        key: "onNameCommit",
        value: function onNameCommit(value) {
          if (value != null && value != "") {
            this.name = value;
        ...
        key: "onEmailCommit",
        value: function onEmailCommit(value) {
          if (value != null && value != "") {
            this.email = value;
    ...
    WelcomeComponent.ɵfac = function WelcomeComponent_Factory(t) {
      return new (t || WelcomeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_user_profile_service__WEBPACK_IMPORTED_MODULE_1__["UserProfileService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]));
    };
    ...
    WelcomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 17,
      vars: 2,
      consts: [[1, "container"], [1, "col-lg-8", "col-md-8", "mx-auto"], [1, "card", "rounded", "shadow"], [1, "card-header"], [1, "mb-0"], [1, "card-body"], [1, "form-group"], ["type", "text", "placeholder", "Enter Name", "id", "uname", 1, "form-control", "form-control-lg", 3, "value", "blur"], ["type", "text", "placeholder", "Enter Email", "id", "email", 1, "form-control", "form-control-lg", 3, "value", "blur"], ["type", "submit", "id", "btnLogin", 1, "btn", "btn-success", "btn-lg", "float-right", 3, "click"]],
      template: function WelcomeComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("blur", function WelcomeComponent_Template_input_blur_10_listener($event) {
            return ctx.onNameCommit($event.target.value);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("blur", function WelcomeComponent_Template_input_blur_14_listener($event) {
            return ctx.onEmailCommit($event.target.value);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function WelcomeComponent_Template_button_click_15_listener($event) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](WelcomeComponent, [{
        ...
        return [{
          type: _services_user_profile_service__WEBPACK_IMPORTED_MODULE_1__["UserProfileService"]
        }, {
  ...
  /***/
  function srcModelsAnswerModelTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcModelsQuestionModelTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/rahuljeswani/Documents/Extra/TestMax QnA/qna-web-3/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
